...
# settings
(
  bash "$BASE_DIR/steps/bootstraps/bootstrap_server.sh"
  bash "$BASE_DIR/steps/bootstraps/bootstrap_billing.sh"
  bash "$BASE_DIR/steps/bootstraps/bootstrap_edocbroker.sh"
)
